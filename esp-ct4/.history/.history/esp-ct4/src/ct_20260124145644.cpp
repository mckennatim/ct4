...
CT_Config sensors[4] = {
  {0, GAIN_ONE, 0.0001875,  104.7, 0.922, 15, "Heat_Pump"},
  {1, GAIN_ONE, 0.0001875,  104.7, 0.922, 15, "Solar"},
  {2, GAIN_ONE, 0.0001875,  104.7, 0.922, 50, "EV"},
  {3, GAIN_ONE, 0.0001875,  104.7, 0.922, 15, "empty"},
};
