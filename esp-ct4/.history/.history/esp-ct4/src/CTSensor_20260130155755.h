...
private:
    ...
    float readCurrent() {
        ...
        _ads->setDataRate(RATE_ADS1115_860SPS); // Maximize sampling speed (1.2ms per sample)
        ...
        long sumSquares = 0;
        // IMPROVEMENT: 540 samples @ 860SPS takes ~650ms.
        // This provides ~38 cycles of 60Hz data for good RMS averaging
        // without blocking MQTT for too long (< 1s constant).
        const int samples = 540; 
